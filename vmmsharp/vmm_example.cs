...
//constexpr auto Offset_SafetyZoneRadius = 0x0720;
    ...
    static void ExampleVmm()
    {
        ...
        //vmm.PidGetFromName("Conquer.exe", out cid);
        var m = vmm.Map_GetModuleFromName(12728, "TslGame.exe");
        byte[] worldBase = vmm.MemRead(12728, m.vaBase + 0x090F2FD0, 128, 0);

        byte[] nameBase = vmm.MemRead(12728, m.vaBase + 0x92D19F0, 128, 0);
